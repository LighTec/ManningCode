...
public class MediaPlayerTester extends Application {
    ...
    public class MediaControl extends BorderPane {
        ...
        private final Image PlayButtonImage = new Image(MediaPlayerTester.class.getResourceAsStream("playbutton.png"));
        private final Image PauseButtonImage = new Image(MediaPlayerTester.class.getResourceAsStream("pausebutton.png"));
