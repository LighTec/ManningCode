...
package com.mycompany.mavenardulinktest;
/*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
            ...
            public void run() {
                try {
                    ...
                    UIManager.setLookAndFeel(
                      NimbusLookAndFeel.class.getCanonicalName());
        ...
        btnConnect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String connectionPort = 
                      connectionPanel.getConnectionPort();
                int baudRate = 
                      Integer.parseInt(connectionPanel.getBaudRate());

                // 9. Let's go. Link it to Arduino.
                boolean connected = 
                  Link.getDefaultInstance().connect(connectionPort, 
                                                            baudRate);
